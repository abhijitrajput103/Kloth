                ...
                <div className="row">
                    ...
                    <div className="col-md-9">
                        <div className="card shadow-sm p-4 rounded-2xl">
                            <h2 className="text-primary text-uppercase mb-4 text-center">Admin Profile</h2>
                            <div className="card-body">
                                <div className="mb-3">
                                    <h4><i className="fas fa-user me-2"></i> Name: <span className="text-muted">{auth?.user?.username}</span></h4>
                                </div>
                                <div className="mb-3">
